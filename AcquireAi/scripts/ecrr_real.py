...
from scripts.ecrr_engine import ECRREngine
from scripts.agent_spawner import AgentSpawner
...
def emulate_target():
    ...
    try:
        ...
        # Execute emulation using REAL ECRR engine
...
def condense_emulation():
    ...
    try:
        ...
        # Execute condensation using REAL ECRR engine
...
def repurpose_for_legion():
    ...
    try:
        ...
        # Execute repurposing using REAL ECRR engine
...
def redeploy_as_agents():
    ...
    try:
        ...
        # Execute redeployment using REAL ECRR engine and agent spawner
...
def execute_full_pipeline():
    ...
    try:
        ...
        # Execute full ECRR pipeline using REAL engine
...
def spawn_quick_agent():
    ...
    try:
        ...
        # Deploy quick agent using real spawner
...
def spawn_agent_swarm():
    ...
    try:
        ...
        # Spawn swarm using real spawner
...
def get_ecrr_status():
    ...
    try:
        ...
        status_result = {
            ...
            'engine_type': 'real',  # Confirm real engine is active
            'statistics': {
